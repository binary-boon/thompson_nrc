...
export default function OurValues(){
    ...
    <div className=" font-Mulish flex flex-col w-[100%] m-5 mt-20 p-10">
        ...
        <div className="flex xs:flex-col md:flex-row lg:flex-row w-[100%] justify-center my-5 ">

            <div className="flex md:w-[50%] lg:w-[50%] xs:w-[100%] font-Mulish font-extrabold justify-center md:text-8xl lg:text-8xl xs:text-7xl"><h1>Our Values</h1></div>

            <div className="flex md:w-[50%] lg:w-[50%] xs:w-[100%] xs:mt-5  "><h2 className="font-Mulish justify-center text-2xl xs:mr-5 md:mr-5 lg:mr-5 md:pr-2 lg:pr-2 text-left">We are committed to fostering a thriving, inclusive community where empowerment, collaboration, and cultural awareness drive meaningful change. These core principles shape our mission and inspire us to build a better, brighter future for all.</h2></div>

        </div>



        <div className="flex xs:flex-col  md:flex-row lg:flex-row lg:w-[100%] md:w-[100%] mt-48 mr-5">

            <div className="flex justify-center flex-col xs:w-[100%] md:w-1/3 lg:w-1/3  text-center">
            ...
            <div className="flex justify-center flex-col xs:w-[100%] md:w-1/3 lg:w-1/3 xs:mt-8  text-center">
        ...
        <div className="flex  xs:flex-col  md:flex-row lg:flex-row lg:w-[100%] md:w-[100%] md:mt-20 lg:mt-20 xs:mt-5 mr-5">
