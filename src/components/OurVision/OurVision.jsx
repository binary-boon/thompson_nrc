...
<div className="flex flex-row w-[100%] justify-center m-5 mt-36 p-10 ml-10 mr-5 mb-20">
    ...
    <div className="flex flex-col w-[70%]">
        ...
        <h3 className="text-xl font-light pr-7" >A catalyst for local innovation, enabling grassroots projects that make a meaningful impact in the neighborhood.</h3>
        ...
        <h3 className="text-xl font-light pr-7" >A neighborhood where residents take pride in their community identity and actively contribute to its growth.</h3>
